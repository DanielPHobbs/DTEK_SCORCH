...
$RunbookInputProperty1 = "recipient"
$RunbookInputValue1    = "danny@dtek.com"
$RunbookInputProperty2 = "message"
$RunbookInputValue2    = "Remote runbook launcher"
#Begin ################
...
# + Specifying that the element needed for that property is the GUID based Id
 
$RetreivedGUID1 = GetScorchProperty $XML $RunbookInputProperty1 "In" "Id"
write-host "Property GUID = " $RetreivedGUID1

$RetreivedGUID2 = GetScorchProperty $XML $RunbookInputProperty2 "In" "Id"
write-host "Property GUID = " $RetreivedGUID2
...
<d:Parameters>&lt;Data&gt;&lt;Parameter&gt;&lt;ID&gt;{$($RetreivedGUID1)}&lt;/ID&gt;&lt;Value&gt;$($RunbookInputValue1)&lt;/Value&gt;&lt;/Parameter&gt;&lt;Parameter&gt;&lt;ID&gt;{$($RetreivedGUID2)}&lt;/ID&gt;&lt;Value&gt;$($RunbookInputValue2)&lt;/Value&gt;&lt;/Parameter&gt;&lt;/Data&gt;</d:Parameters>
</m:properties>
</content>
</entry>
"@
