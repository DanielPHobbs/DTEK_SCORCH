...
#est-TlsConnection -ComputerName scomwebconsole.dtek.com -Port 443 -Protocol Tls12 
Test-TlsConnection -ComputerName scowebconsole.dtek.com -Port 443 -Protocol Tls12 