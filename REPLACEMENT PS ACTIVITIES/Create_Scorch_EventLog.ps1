...
Function New-CustomEvent {
    ...
    ( 
        ...
        [Parameter(Position=2, Mandatory = $false, HelpMessage="Provide event source", ValueFromPipeline = $true)]  $EventID   = "102",
...
$message ="Created New Event log for Orchestrator on " 
