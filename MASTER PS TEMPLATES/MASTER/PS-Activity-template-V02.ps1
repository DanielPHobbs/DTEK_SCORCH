...
$LinkErrors += Invoke-Sqlcmd -ServerInstance "dteksq2017-n1" -Database "DTEK_DBA" -Query "SELECT * FROM SCO_LinkedServersError where Actionstate=0"
$LinkErrors=$LinkErrors | out-string
